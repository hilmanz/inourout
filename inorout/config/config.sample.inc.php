...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	...
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/marlboro_inorout/inorout/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "http://{$_SERVER['HTTP_HOST']}/marlboro_inorout/inorout/public_html/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/var/www/marlboro_inorout/inorout/public_html/public_assets/";

$CONFIG['UPLOAD_ASSET'] = "/var/www/marlboro_inorout/inorout/public_html/public_assets/";
$CONFIG['UPLOAD_SOURCE_ASSET'] = "/var/www/marlboro_inorout/inorout/public_html/assets/content/phase4/news/";
