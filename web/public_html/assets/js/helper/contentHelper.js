		...
		function paging_ajax_postmoderation(fungsi,start){
			...
			$.post(basedomain+pages+"/ajax",{start:start,needs:"post_moderation",startdate:startdate,enddate:enddate,search:search},function(data){
				if(data){
					if(data.result){
						var html = "";
		...
		function paging_ajax_commentmoderation(fungsi,start){
			$('.theContent').html('');
			$('.theContent').append('<div class="loaders"><img src="'+basedomain+'assets/images/loader.gif"></div>');
			$.post(basedomain+pages+"/ajax",{start:start,needs:"comment_moderation",startdate:startdate,enddate:enddate,search:search},function(data){
				if(data){
					if(data.result){
						var html = "";
		...
		function paging_ajax_venuemoderation(fungsi,start){
			$('.theContent').html('');
			$('.theContent').append('<div class="loaders"><img src="'+basedomain+'assets/images/loader.gif"></div>');
			$.post(basedomain+pages+"/ajax",{start:start,needs:"venue_moderation",startdate:startdate,enddate:enddate,search:search},function(data){
				if(data){
					if(data.result){
						var html = "";
