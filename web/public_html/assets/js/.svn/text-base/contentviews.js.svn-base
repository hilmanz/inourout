...
function postmoderationviews(data){
	...
	$.each(data,function(i,e){
		...
		html+="			<a class='icons icon_delete' href='"+basedomain+"moderation/unpublish/"+e.id+"'>&nbsp;</a>";
		html+="	</div>";
	});
	return html;
}
...
function commentmoderationviews(data){
	...
	$.each(data,function(i,e){
		...
		html+="			<a class='icons icon_delete' href='"+basedomain+"moderation/uncomment/"+e.id+"'>&nbsp;</a>";
		html+="	</div>";
	});
	return html;
}
...
function venuemoderationviews(data){
	...
	$.each(data,function(i,e){
		...
		html+="			<h3 class='venueName fl'>"+e.keywords+"</h3>";
		html+="			<p class='venueAddress'>"+e.venuename+", "+e.city+"</p>";
		html+="		</div>";
		html+="			<a class='icons icon_expand' href='"+basedomain+""+pages+"/detailVenue/"+e.id+"'>&nbsp;</a>";
		html+="			<a class='icons icon_delete showPopup' href='"+basedomain+""+pages+"/unpublishvenue/"+e.id+"' onclick='return confirm(Are you sure you want to delete this?)'>&nbsp;</a>";
		html+="	</div>";
	});
	return html;
}
...
function galleryviews(data){
	...
	$.each(data,function(i,e){
		...
		html +="                	<span class='desc1'>"+e.title+" - "+e.posted_date+"</span>";
